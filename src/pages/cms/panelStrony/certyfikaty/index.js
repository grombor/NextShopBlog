...
import CertificateTable from '../../../../components/molecules/CertificateTable';
        ...
        <div className="py-4">
          ...
          <PanelTemplate>
            ...
            <div className='my-4' onClick={() => {
              router.push('/cms/panelStrony/cartyfikaty/nowy')
            }}>
            <Button type='danger'>Stwórz nowy certyfikat</Button>
            </div>
            <CertificateTable data={homePage} label={label} />
          </PanelTemplate>
        </div>
      </div>
    </Layout>
