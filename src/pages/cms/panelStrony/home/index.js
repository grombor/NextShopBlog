        ...
        <div className="py-4">
          ...
          <PanelTemplate>
            ...
            <div className='my-4' onClick={() => {
              router.push('/cms/panelStrony/sekcje/nowa?target=home')
            }}>
...
export async function getServerSideProps() {
  try {
    const [home] =
      await axios.all([axiosWithAuth.get(process.env.NEXT_PUBLIC_API_URL + '/api/cms/section-data/page-demo-cms/home'),
      ]);
    return {
      props: {
